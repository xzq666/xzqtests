...
/**
 话题所有feed的排序类型,使用方法见父类`UMComPullRequest`
...
/**
 获取未读feed个数，个数为NSDictionary中key为`unread_count`
...
/**
 ...
 @param result 结果
 */
+ (void)fetchUnreadFeedCountWithSeq:(NSNumber *)seq result:(RequestServerDataResponse)result;
