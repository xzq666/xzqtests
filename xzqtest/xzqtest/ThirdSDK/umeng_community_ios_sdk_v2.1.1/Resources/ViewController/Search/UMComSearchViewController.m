...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    if (self.navigationController.viewControllers.count > 1) {
        self.feedsTableView.frame = CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height-kUMComLoadMoreOffsetHeight-20);
    }else{
        self.feedsTableView.frame = CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height-kUMComLoadMoreOffsetHeight+44);
    }
}
