...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        CGFloat likeUserViewWidth = frame.size.width-likeButtonOriginX-self.likeViewOriginX+3;
        ...
        self.likeUserListView = [[UICollectionView alloc]initWithFrame:CGRectMake(self.likeViewOriginX, 0, likeUserViewWidth, frame.size.height) collectionViewLayout:layout];
...
{
    CGFloat likeButtonOriginX = 15;
    CGFloat likeUserViewWidth = self.frame.size.width-likeButtonOriginX-self.likeViewOriginX+3;
    CGFloat itemWidth = ItemWidth;
