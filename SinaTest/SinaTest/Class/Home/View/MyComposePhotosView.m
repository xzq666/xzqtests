...
#import "MyComposePhotoViewCell.h"
#import <AssetsLibrary/AssetsLibrary.h>
#import "JKImagePickerController.h"

@interface MyComposePhotosView()<JKImagePickerControllerDelegate , UICollectionViewDataSource , UICollectionViewDelegate>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    MyComposePhotoViewCell *cell = (MyComposePhotoViewCell *)[collectionView dequeueReusableCellWithReuseIdentifier:kPhotoCellIdentifier forIndexPath:indexPath];
...
- (void)deleteView:(id)sender{
    ...
    for (MyComposePhotoViewCell *currentCell in [self.collectionView subviews]){
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[MyComposePhotoViewCell class] forCellWithReuseIdentifier:kPhotoCellIdentifier];
